    ...
    public function run()
    {
        DB::table('layanan')->insert([
            ...
            [
                ...
                'tgl_mulai' => now()->addDays(15)->toDateString(),
                'tgl_selesai' => now()->addDays(16)->toDateString(),
            ...
            [
                ...
                'tgl_selesai' => now()->addDays(20)->toDateString(),
                'jam_pertemuan' => '09:00:00',
            ...
            [
                ...
                'materi' => 'Audit K3',
                'jenis_pertemuan' => 'offline',
                'tgl_mulai' => now()->addDays(25)->toDateString(),
                'tgl_selesai' => now()->addDays(26)->toDateString(),
                'jam_pertemuan' => '09:00:00',
                'lokasi' => 'Kantor Klien',
                'kapasitas' => null,
                'harga' => 0,
