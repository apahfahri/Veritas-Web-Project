@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex flex-col items-center justify-center gap-3 w-full">
        <div>
            ...
            <div>
                <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1 text-center">
                    Menampilkan
                    ...
                    @else
                        <span class="font-black text-slate-700">{{ $paginator->count() }}</span>
                    @endif
                    dari
