...
@section('page-subtitle', 'Perbarui data atau dokumen sertifikasi')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
                <form method="POST" action="{{ route('admin.sertifikat.update', $sertifikat->no_sertifikat) }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
