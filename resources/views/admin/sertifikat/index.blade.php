...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-xl font-semibold text-[#7d2ae7]">Sertifikat Terbit ({{ $sertifikats->total() }})</h2>
    <a href="{{ route('admin.pendaftaran.index') }}?status=selesai"
       class="border border-[#7d2ae7] text-[#7d2ae7] px-4 py-2 rounded-lg text-sm hover:bg-[#7d2ae7] hover:text-white transition">
    ...
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y">
            ...
            <tr class="hover:bg-gray-50">
                <td class="p-4">
                    <span class="font-mono font-semibold text-[#7d2ae7]">{{ $s->no_sertifikat }}</span>
                </td>
                ...
                <td class="p-4">
                    <a href="{{ route('verification') }}"
                       class="text-[#7d2ae7] text-xs hover:underline">
                        🔍 Verifikasi
                    </a>
                </td>
            </tr>
