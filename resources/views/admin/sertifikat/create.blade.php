...
<div class="max-w-2xl">
    <div class="mb-4">
        <a href="{{ route('admin.sertifikat.index') }}" class="text-gray-500 hover:text-[#00A8A8] text-sm">← Kembali ke Daftar Sertifikat</a>
    </div>

    <!-- INFO PENDAFTARAN -->
    <div class="bg-[#F5F7FA] border rounded-xl p-4 mb-6 text-sm">
        <h3 class="font-semibold text-[#0A2540] mb-2">Data Pendaftaran</h3>
    ...
    <div class="bg-white p-8 rounded-xl shadow">
        <div class="flex items-center gap-3 mb-6">
            <div class="w-10 h-10 bg-[#FF7A00] rounded-xl flex items-center justify-center text-white text-xl">🏆</div>
            <div>
                <h2 class="text-xl font-semibold text-[#0A2540]">Form Penerbitan Sertifikat</h2>
        ...
        <form method="POST" action="{{ route('admin.sertifikat.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="nama_lengkap"
                       ...
                       class="w-full border rounded-lg p-3 focus:ring-2 focus:ring-[#FF7A00] focus:outline-none @error('nama_lengkap') border-red-400 @enderror">
            ...
            <div>
                ...
                <input type="date" name="tanggal_terbit"
                       ...
                       class="w-full border rounded-lg p-3 focus:ring-2 focus:ring-[#FF7A00] focus:outline-none @error('tanggal_terbit') border-red-400 @enderror">
            ...
            <div class="flex gap-3 pt-2">
                ...
                <button type="submit"
                        ...
                        class="flex-1 bg-[#FF7A00] text-white py-2.5 rounded-lg hover:opacity-90 font-semibold">
