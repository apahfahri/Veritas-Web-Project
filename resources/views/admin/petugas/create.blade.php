...
@section('page-subtitle', 'Tambahkan data petugas / staf baru')
...
<div class="max-w-2xl">
    ...
    <div class="bg-white p-8 rounded-xl shadow">
        <h2 class="text-xl font-semibold text-[#0A2540] mb-6">Form Tambah Petugas</h2>
        ...
        <form method="POST" action="{{ route('admin.petugas.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="spesialisasi" value="{{ old('spesialisasi') }}"
                       placeholder="Contoh: Keselamatan Kerja & SMK3"
                       class="w-full border rounded-lg p-3 focus:ring-2 focus:ring-[#00A8A8] focus:outline-none">
            </div>
