...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-xl font-semibold text-[#7d2ae7]">Daftar Pemateri ({{ $pemateris->total() }})</h2>
    ...
    <table class="w-full text-sm">
        <thead class="bg-gray-50 text-gray-600">
            <tr>
                ...
                <th class="text-left p-4">Kompetensi</th>
        ...
        <tbody class="divide-y">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="p-4 text-gray-600 max-w-xs">{{ $p->kompetensi ?? '-' }}</td>
                <td class="p-4">
            ...
            @empty
            <tr>
                <td colspan="6" class="p-8 text-center text-gray-500">Belum ada pemateri terdaftar</td>
            </tr>
            @endforelse
        </tbody>
    </table>
    <div class="p-4 border-t">{{ $pemateris->links() }}</div>
</div>
