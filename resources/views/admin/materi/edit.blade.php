...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <a href="{{ route('admin.materi.index') }}" class="inline-flex items-center gap-2 text-slate-400 hover:text-slate-900 font-bold text-xs uppercase tracking-widest transition">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <form method="POST" action="{{ route('admin.materi.update', $materi->id_materi) }}" enctype="multipart/form-data" class="p-7 space-y-7">
            @csrf
            @method('PUT')
            ...
            <div class="flex gap-4 pt-4 border-t border-slate-100">
                <a href="{{ route('admin.materi.index') }}" class="px-6 py-3 text-sm font-black text-slate-400 hover:text-slate-600 transition">Batal</a>
