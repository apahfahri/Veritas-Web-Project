    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
                ...
                <div class="space-y-4">
                    <div>
                        <p class="text-[10px] font-black text-cyan-500 uppercase tracking-tighter">Nama Peserta</p>
                        <p class="text-sm font-black text-slate-900">{{ $pendaftaran->user?->nama }}</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-black text-cyan-500 uppercase tracking-tighter">Program Pelatihan</p>
                        <p class="text-sm font-black text-slate-900 leading-tight">{{ $pendaftaran->jadwal?->jenis?->nama ?? ($pendaftaran->jadwal?->kategori?->nama ?? '—') }}</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-black text-cyan-500 uppercase tracking-tighter">Status Pendaftaran</p>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
                <form method="POST" action="{{ route('subadmin.sertifikat.store') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="flex flex-wrap gap-4 pt-4">
                        ...
                        <button type="submit" id="submitBtn"
                            ...
                            <svg class="w-5 h-5 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg>
                            <span id="submitBtnText">Simpan Sertifikat</span>
                        </button>
                    </div>
                </form>
            </div>
