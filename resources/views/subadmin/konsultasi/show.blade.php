...
<div class="mb-8 flex items-center justify-between">
    <div class="flex items-center gap-4">
        ...
        <div>
            <p class="text-xs text-slate-500 font-extrabold uppercase tracking-widest">Layanan Konsultasi K3</p>
            <h2 class="text-xl font-black text-slate-900 tracking-tight">Detail Proses Konsultasi</h2>
        </div>
    </div>
