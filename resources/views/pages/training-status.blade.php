...
<div class="min-h-screen bg-[#F5F7FA] py-12">
    <div class="max-w-4xl mx-auto px-6">
        ...
        @if(session('registration_success'))
            <div class="mb-8 p-6 bg-blue-50 border border-blue-200 text-blue-800 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm animate-fade-in max-w-2xl mx-auto">
                ...
                @php
                    ...
                    $waText = "Halo Veritas, Saya ingin konfirmasi pembayaran untuk Pendaftaran Program Veritas.";
                    $waUrl = "https://wa.me/" . $waNumber . "?text=" . rawurlencode($waText);
                @endphp
                <a href="{{ $waUrl }}" target="_blank" class="w-full md:w-auto shrink-0 inline-flex items-center justify-center gap-2 bg-[#22c55e] hover:bg-[#16a34a] text-white px-5 py-3 rounded-xl text-sm font-bold shadow-md transition active:scale-95">
