...
@section('title', 'Pendaftaran Audit K3 — PT Katiga Veritas Indonesia')
...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/30 to-slate-100">
    ...
    {{-- ── HERO HEADER ─────────────────────────────────────────────────── --}}
    <div class="relative overflow-hidden bg-gradient-to-r from-[#14532d] via-[#1E6B3D] to-[#22c55e]/80 text-white py-14 shadow-sm">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            <div class="flex items-center gap-3 mb-1">
                ...
                <span class="text-white/80 text-sm font-medium">Audit K3</span>
            </div>
            <div class="flex items-start gap-5 mt-4">
                <div class="shrink-0 w-14 h-14 rounded-2xl bg-white/10 backdrop-blur border border-white/20 flex items-center justify-center text-3xl shadow-lg">
                    <i class="fi fi-rr-clipboard-list text-white text-2xl"></i>
                </div>
                <div>
                    <h1 class="text-3xl md:text-4xl font-extrabold tracking-tight leading-tight">Audit K3 Veritas</h1>
                    <p class="text-emerald-100/80 mt-2 text-base max-w-xl font-light leading-relaxed">
                        Layanan audit K3 profesional untuk memastikan kesesuaian implementasi sistem manajemen K3 di perusahaan Anda.
                    </p>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-6 py-10">
        <div class="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div class="lg:col-span-2">
                @if(session('success'))
                    <div class="mb-6 bg-emerald-50 border border-emerald-300 text-emerald-800 p-5 rounded-2xl flex items-start gap-3 shadow-sm">
                ...
                @if($errors->any())
                    <div class="mb-6 bg-red-50 border border-red-300 text-red-700 p-5 rounded-2xl shadow-sm">
                    ...
                    <div id="step-1" class="step-section bg-white rounded-3xl border border-slate-100 shadow-sm p-8 space-y-6">
                        ...
                        <div class="bg-emerald-50/60 border border-emerald-200/60 rounded-2xl p-4 flex items-start gap-3">
                            ...
                            <p class="text-sm text-emerald-800 font-medium leading-relaxed">
                                Layanan audit Veritas ditujukan khusus untuk <strong>badan usaha / perusahaan</strong> (B2B) guna meninjau efektivitas kepatuhan sistem K3 Anda.
                            </p>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="nama_perusahaan" required
                                       ...
                                       placeholder="PT / CV / Instansi Pemerintah..."
                    ...
                    <div id="step-2" class="step-section hidden bg-white rounded-3xl border border-slate-100 shadow-sm p-8 space-y-6">
                        ...
                        <div class="bg-blue-50/60 border border-blue-200/60 rounded-2xl p-4 flex items-start gap-3">
                            ...
                            <p class="text-sm text-blue-800 font-medium leading-relaxed">
                                Isi data <strong>Person in Charge (PIC)</strong> perusahaan Anda — penanggung jawab yang akan berkoordinasi langsung mengenai berkas dan jadwal pelaksanaan audit.
                            </p>
                        </div>
                            ...
                            <div class="grid sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="email" name="email" required
                                           ...
                                           class="w-full border border-slate-200 rounded-xl px-4 py-3.5 text-sm focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all placeholder-slate-400 bg-slate-50/50">
                                    <p class="text-xs text-slate-400 mt-1.5">Pemberitahuan & berkas audit dikirim ke email ini.</p>
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-slate-700 mb-1.5">
                                    ...
                                    <input type="text" name="no_telp" required
                                           ...
                                           class="w-full border border-slate-200 rounded-xl px-4 py-3.5 text-sm focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all placeholder-slate-400 bg-slate-50/50">
                                    <p class="text-xs text-slate-400 mt-1.5">Tim auditor kami akan menghubungi via WhatsApp ini.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="step-3" class="step-section hidden bg-white rounded-3xl border border-slate-100 shadow-sm p-8 space-y-6">
                        <div class="flex items-center gap-3 pb-5 border-b border-slate-100">
                            ...
                            <div>
                                ...
                                <h2 class="text-xl font-black text-slate-900">Preferensi Audit</h2>
                            </div>
                        </div>
                        ...
                        <div class="space-y-5">
                            <div class="grid sm:grid-cols-2 gap-5">
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-slate-700 mb-2">
                                        Rencana Tanggal Pelaksanaan <span class="text-red-500">*</span>
                                    </label>
                                    ...
                                    <p class="text-xs text-slate-400 mt-1.5">Tanggal usulan mulai audit lapangan / dokumen.</p>
                                </div>

                                {{-- Mode Pertemuan --}}
                                <div>
                                    <label class="block text-sm font-bold text-slate-700 mb-2">
                                        Preferensi Mode Audit <span class="text-red-500">*</span>
                                    </label>
                            ...
                            <div id="lokasi-box" class="{{ old('mode_pertemuan', 'offline') === 'offline' ? '' : 'hidden' }}">
                                <label class="block text-sm font-bold text-slate-700 mb-2">
                                    Lokasi Pelaksanaan Audit <span class="text-red-500">*</span>
                                </label>
                                <textarea name="lokasi" id="lokasi" rows="2"
                                          placeholder="Alamat lengkap tempat pelaksanaan audit..."
                            ...
                            <div>
                                <label class="block text-sm font-bold text-slate-700 mb-2">
                                    Kebutuhan Spesifik / Catatan Tambahan (Opsional)
                                </label>
                                <textarea name="catatan_tambahan" id="catatan_tambahan" rows="3"
                                          placeholder="Tuliskan jika ada standar acuan spesifik (SMK3 PP 50, ISO 45001, dll) atau catatan tambahan lainnya..."
                        ...
                        <div class="bg-gradient-to-br from-slate-50 to-emerald-50/50 border border-slate-200/60 rounded-2xl p-5 space-y-2">
                            <p class="text-xs font-black text-slate-600 uppercase tracking-wider mb-3">Ringkasan Pengajuan Audit</p>
                            <div class="flex items-center gap-2 text-xs text-slate-600">
                                <span class="text-emerald-500 flex items-center"><i class="fi fi-rr-check"></i></span> Permintaan akan <strong>ditinjau awal</strong> oleh subadmin cabang terdekat.
                            </div>
                            <div class="flex items-center gap-2 text-xs text-slate-600">
                                <span class="text-emerald-500 flex items-center"><i class="fi fi-rr-check"></i></span> Penjadwalan & <strong>penawaran harga final</strong> akan dirilis setelah tinjauan berkas selesai.
                            </div>
                            <div class="flex items-center gap-2 text-xs text-slate-600">
                                <span class="text-emerald-500 flex items-center"><i class="fi fi-rr-check"></i></span> Dokumen invoice & instruksi transfer dikirim otomatis setelah harga disepakati.
                            </div>
                        </div>
            ...
            <div class="space-y-5 lg:sticky lg:top-24">
                ...
                <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-6">
                    <h3 class="font-black text-slate-900 text-base mb-5">Alur Layanan Audit</h3>
                    <ol class="space-y-5 relative">
                        ...
                        @php
                        $alur = [
                            ['<i class="fi fi-rr-comment-alt text-lg"></i>', 'Kirim Pengajuan', 'Ajukan data perusahaan & kebutuhan audit Anda.'],
                            ['<i class="fi fi-rr-eye text-lg"></i>', 'Tinjauan Dokumen', 'Subadmin memverifikasi pengajuan & kelayakan administratif.'],
                            ['<i class="fi fi-rr-calendar text-lg"></i>', 'Penjadwalan Lapangan', 'Penyusunan jadwal audit plan dan penunjukan auditor.'],
                            ['<i class="fi fi-rr-file-invoice text-lg"></i>', 'Tagihan & Pembayaran', 'Invoice dirilis sesuai skala lingkup audit yang diajukan.'],
                            ['<i class="fi fi-rr-checkbox text-lg"></i>', 'Audit & Sertifikasi', 'Pelaksanaan audit, pelaporan temuan, dan rilis rekomendasi.'],
                        ];
                        @endphp
                ...
                {{-- Keunggulan --}}
                <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-6">
                    <h3 class="font-black text-slate-900 text-base mb-4">Mengapa Audit Bersama Kami?</h3>
                    <ul class="space-y-3">
                        @foreach([
                            ['<i class="fi fi-rr-trophy text-[#1E6B3D] text-lg"></i>','Auditor berlisensi resmi & kompeten'],
                            ['<i class="fi fi-rr-target text-[#1E6B3D] text-lg"></i>','Metodologi audit komprehensif & objektif'],
                            ['<i class="fi fi-rr-clipboard-list text-[#1E6B3D] text-lg"></i>','Rekomendasi corrective action yang praktis'],
                            ['<i class="fi fi-rr-lock text-[#1E6B3D] text-lg"></i>','Keamanan data & kerahasiaan korporat terjamin'],
                        ] as $item)
                ...
                <div class="relative overflow-hidden bg-gradient-to-br from-[#1E6B3D] via-[#24824A] to-[#22c55e]/80 text-white p-6 rounded-3xl shadow-lg">
                    ...
                    <h3 class="font-black text-base mb-2 relative z-10">Ada Pertanyaan Mengenai Audit?</h3>
                    <p class="text-xs text-emerald-100 mb-5 relative z-10 leading-relaxed">Hubungi customer service kami jika Anda memerlukan penjelasan awal mengenai skema audit.</p>
                    <a href="https://wa.me/6281234567890?text={{ urlencode('Halo, saya ingin menanyakan perihal skema audit K3 di PT Katiga Veritas Indonesia.') }}"
                       target="_blank"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if($errors->any())
            const hasStep3Error = @json($errors->has('tanggal_usul') || $errors->has('mode_pertemuan') || $errors->has('lokasi') || $errors->has('catatan_tambahan'));
