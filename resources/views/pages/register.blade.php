                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="username" type="text" name="username" value="{{ old('username') }}"
                                ...
                                class="w-full border border-gray-300 rounded-lg pl-10 pr-3 py-2.5 text-sm focus:outline-none focus:border-[#7d2ae7] focus:ring-2 focus:ring-teal-100 transition {{ $errors->has('username') ? 'border-red-400' : '' }}">
                        </div>
                    </div>
