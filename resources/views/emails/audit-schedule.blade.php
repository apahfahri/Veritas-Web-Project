...
<head>
    <meta charset="utf-8">
    <title>Konfirmasi Jadwal Pelaksanaan Audit</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h2>Jadwal Pelaksanaan Audit K3</h2>
        </div>
        
        <div class="content">
            <p class="greeting">Yth. Perwakilan {{ $pendaftaran->perusahaan->nama ?? 'Klien' }},</p>
            
            <p class="intro">Permintaan audit perusahaan Anda telah berhasil dijadwalkan oleh tim kami. Berikut adalah rincian pelaksanaan audit / kunjungan lapangan Anda:</p>
            
            <div class="details-box">
                <h4 class="details-title">Detail Pelaksanaan Audit</h4>
                ...
                <div class="details-row">
                    ...
                    <span class="details-value">
                        {{ $pendaftaran->jadwal->tgl_mulai ? $pendaftaran->jadwal->tgl_mulai->format('d M Y') : ($pendaftaran->rencana_tanggal_mulai ? $pendaftaran->rencana_tanggal_mulai->format('d M Y') : '-') }}
                    </span>
                </div>
                ...
                <div class="details-row">
                    <span class="details-label">Mode Audit:</span>
                    <span class="details-value">
                        @php
                ...
                <div class="details-row">
                    <span class="details-label">Lokasi Lapangan:</span>
                ...
                <div class="details-row">
                    ...
                    <span class="details-value">
                        <a href="{{ $pendaftaran->jadwal->link_meet }}" target="_blank" class="link-button">Gabung Pertemuan</a>
                ...
                <div class="details-row">
                    <span class="details-label">Auditor / Petugas:</span>
                    <span class="details-value">
                        <ul class="auditor-list">
                            @foreach($pendaftaran->jadwal->pemateri as $auditor)
                                <li><strong>{{ $auditor->nama_lengkap }}</strong> ({{ $auditor->kompetensi ?? 'Auditor K3' }})</li>
                            @endforeach
                        </ul>
                    </span>
                </div>
            ...
            <p class="intro">Harap untuk mempersiapkan dokumen pendukung terkait sistem manajemen K3 perusahaan Anda dan hadir tepat waktu sesuai jadwal yang telah ditentukan. Jika Anda memiliki pertanyaan lebih lanjut, silakan balas email ini atau hubungi tim administrasi kami.</p>
