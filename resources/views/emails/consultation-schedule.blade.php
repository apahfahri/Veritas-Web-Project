...
<head>
    <meta charset="utf-8">
    <title>Konfirmasi Jadwal Pertemuan Konsultasi</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h2>Jadwal Pertemuan Konsultasi</h2>
        </div>
        
        <div class="content">
            <p class="greeting">Yth. {{ $pendaftaran->user->nama ?? $pendaftaran->user->email }},</p>
            
            <p class="intro">Permintaan konsultasi Anda telah berhasil dijadwalkan oleh tim kami. Berikut adalah rincian pelaksanaan pertemuan konsultasi Anda:</p>
            
            <div class="details-box">
                <h4 class="details-title">Detail Pertemuan</h4>
                ...
                <div class="details-row">
                    ...
                    <span class="details-value">
                        @php
                            $mode = strtolower($pendaftaran->mode_pertemuan ?? $pendaftaran->jadwal->jenis_pertemuan ?? 'online');
                        @endphp
                ...
                <div class="details-row">
                    <span class="details-label">Konsultan:</span>
                    <span class="details-value">
                        <ul class="consultant-list">
                            @foreach($pendaftaran->jadwal->pemateri as $pemateri)
                                <li><strong>{{ $pemateri->nama_lengkap }}</strong> ({{ $pemateri->kompetensi ?? 'Konsultan' }})</li>
                            @endforeach
                        </ul>
                    </span>
                </div>
            ...
            <p class="intro">Harap untuk mempersiapkan diri dan hadir tepat waktu sesuai jadwal yang telah ditentukan. Jika Anda memiliki pertanyaan lebih lanjut, silakan balas email ini atau hubungi tim administrasi kami.</p>
